...
from miseventos.infrastructure.persistence.postgresql.models.database import create_tables
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # En desarrollo permite todos, en producción especifica dominios
